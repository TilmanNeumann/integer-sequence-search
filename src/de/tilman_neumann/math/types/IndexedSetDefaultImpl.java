package de.tilman_neumann.math.types;
...
public class IndexedSetDefaultImpl<T> implements IndexedSet<T> {
	 ...
	 * @see de.tilman_neumann.math.types.IndexedSet#addValue(java.lang.Object)
	 */
	 ...
	 * @see de.tilman_neumann.math.types.IndexedSet#addAll(java.util.Collection)
	 */
